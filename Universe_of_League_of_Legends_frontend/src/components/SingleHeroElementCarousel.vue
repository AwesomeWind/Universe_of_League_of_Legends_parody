<template>
    <div class='SHEC_maind'>
        <ul>
            <li
                v-for="(hero,index) in CarouselList"
                :key="index"
            >
                <div :style="{
                    ...
                    <div class="text">
                        <div>
                            <div>
                                <div>
                                    <img
                                        :src="require(`../assets//img/crest_icon/${regional.find(item => item.formerly === hero.relevantRegion).icon}`)"
                                        alt=""
                                    >
                                </div>
                                <div>
                                ...
                                <div>
                                    <div>
                                        <h1>角色定位：{{ roles.find(item => item.title === hero.role).name}}</h1>
                                    </div>
                                    <div>
                                        <h1>地区:{{ regional.find(item => item.formerly === hero.relevantRegion).translation }}</h1>
                                    </div>
                                </div>
                                <div>
                                    <router-link :to="`/HeroInfo/${hero.formerly}`">
        ...
        <router-link to="/HeroShowCase">查看所有英雄<span class="right_arrow">⇢</span></router-link>
    </div>
</template>
<script>
...
export default {
    ...
    methods: {
        move() {
            var moveWidth =
                document.querySelector(".SHEC_maind>ul>li:first-child")
                    .offsetWidth + 200;
        ...
        getDoms() {
            this.doms.carousel = document.querySelector(".SHEC_maind ul");
        },
    },
                        ...
                        > div {
                            ...
                            > div:nth-child(3) {
                                ...
                                > div:nth-child(1) {
                                    width: 100%;
                                    height: 50%;
                                    border-bottom: solid 1px #c4b998;
                                }
                                border-bottom: solid 1px #c4b998;
                                > div:nth-child(2) {
                                    width: 100%;
